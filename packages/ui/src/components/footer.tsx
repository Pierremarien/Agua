...
export const Footer: React.FC<IFooter> = (props) => {
  ...
  return (
    <footer className={`w-full justify-between px-8 md:flex md:px-16 ${home ? "hidden" : ""}`}>
      {name && (
        <div>
      ...
      {SocialItems && (
        <ul className="space-y-4 py-8 md:py-0">
          ...
          <li className="pt-12 font-light  opacity-60 md:pt-24">© 2024 Bibou Team. All rights reserved.</li>
        </ul>
      )}
    </footer>
  );
